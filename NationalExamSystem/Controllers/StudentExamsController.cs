...
namespace NationalExamSystem.Controllers
{
    public class StudentExamsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,ExamId,StudentId,Mark")] StudentExam studentExam)
        {
            ...
            ViewBag.ExamId = new SelectList(db.Exams, "ExamId", "ExamName", studentExam.ExamId);
            ViewBag.StudentId = new SelectList(db.Students, "StudentId", "Name", studentExam.StudentId);
            return View(studentExam);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,ExamId,StudentId,Mark")] StudentExam studentExam)
        {
            if (ModelState.IsValid)
            {
